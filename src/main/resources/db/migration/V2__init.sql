...
create table indices (id bigserial primary key, id_company long REFERENCES companies(id), per varchar, date date, time time, price_open float, price_high float, price_low float, price_close float, vol long);
